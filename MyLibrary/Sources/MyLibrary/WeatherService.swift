...
class WeatherServiceImpl: WeatherService {
    let url = "http://34.224.222.186:3000/v1/weather"
    ...
    func getTemperature(completion: @escaping (_ response: Result<Int /* Temperature */, Error>) -> Void) {
        ...
        AF.request("http://34.224.222.186:3000/v1/auth", method: .post, parameters: parameters, encoding: JSONEncoding.default, headers: nil).responseDecodable(of: Auth.self) { response in
            ...
            case let .success(auth):
                ...
                AF.request("http://34.224.222.186:3000/v1/weather", method: .get, headers: headers).validate(statusCode: 200..<300).responseDecodable(of: Weather.self) { response in
                    switch response.result {
